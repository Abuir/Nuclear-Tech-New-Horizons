...
public class ArmorUtil {
	...
	public static void register() {
    	...
    	ArmorRegistry.registerHazard(ModItems.fau_helmet, new ArmorRegistry.HazardClass[] { ArmorRegistry.HazardClass.PARTICLE_COARSE, ArmorRegistry.HazardClass.PARTICLE_FINE, ArmorRegistry.HazardClass.GAS_LUNG, ArmorRegistry.HazardClass.BACTERIA, ArmorRegistry.HazardClass.GAS_BLISTERING, ArmorRegistry.HazardClass.GAS_MONOXIDE, ArmorRegistry.HazardClass.LIGHT, ArmorRegistry.HazardClass.SAND, ArmorRegistry.HazardClass.NERVE_AGENT});
    	ArmorRegistry.registerHazard(ModItems.dns_helmet, new ArmorRegistry.HazardClass[] { ArmorRegistry.HazardClass.PARTICLE_COARSE, ArmorRegistry.HazardClass.PARTICLE_FINE, ArmorRegistry.HazardClass.GAS_LUNG, ArmorRegistry.HazardClass.BACTERIA, ArmorRegistry.HazardClass.GAS_BLISTERING, ArmorRegistry.HazardClass.GAS_MONOXIDE, ArmorRegistry.HazardClass.LIGHT, ArmorRegistry.HazardClass.SAND, ArmorRegistry.HazardClass.NERVE_AGENT});
    	...
    	ArmorRegistry.registerHazard(ModItems.euphemium_helmet, new ArmorRegistry.HazardClass[] { ArmorRegistry.HazardClass.PARTICLE_COARSE, ArmorRegistry.HazardClass.PARTICLE_FINE, ArmorRegistry.HazardClass.GAS_LUNG, ArmorRegistry.HazardClass.BACTERIA, ArmorRegistry.HazardClass.GAS_BLISTERING, ArmorRegistry.HazardClass.GAS_MONOXIDE, ArmorRegistry.HazardClass.LIGHT, ArmorRegistry.HazardClass.SAND, ArmorRegistry.HazardClass.NERVE_AGENT});
