...
public class HazardRegistry {
	...
	//digma
	public static final float osm = 0.010F;
	...
	public static void registerItems() {
    	...
    	HazardSystem.register(ModItems.ingot_arsenic_bronze, makeData(TOXIC, ars*nugget));
    	HazardSystem.register(OreDictManager.ABRONZE.lightBarrel(), makeData(TOXIC, ars*nugget*4));
    	HazardSystem.register(OreDictManager.ABRONZE.plateCast(), makeData(TOXIC, ars*nugget*3));
    	...
    	if (GeneralConfig.enable528) {
			...
			registerHazItem(ModItems.balefire_and_steel, bf*nugget, 5.0F);
    	}
		...
		HazardSystem.register(ModBlocks.ore_arsenic, makeData(TOXIC, ars*ore));
